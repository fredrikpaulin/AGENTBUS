...
export function validateFrame(frame) {
  ...
  if (typeof frame.id !== "number" || frame.id < 0 || frame.id > 2047) return "id must be 0-2047";
  ...
  if (frame.priority !== undefined && (frame.priority < 0 || frame.priority > 7)) return "priority must be 0-7";
  return null;
}
